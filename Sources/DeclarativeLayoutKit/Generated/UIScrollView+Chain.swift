...
public extension UIScrollView {
    ...
    [@available(iOS 17.4, *)]
    @discardableResult
    func contentAlignmentPoint(_ newValue: CGPoint) -> Self {
        contentAlignmentPoint = newValue
        return self
    }
    ...
    @discardableResult
    func delegate(_ newValue: any UIScrollViewDelegate?) -> Self {
        delegate = newValue
        return self
    }
    ...
    [@available(iOS 17.4, *)]
    @discardableResult
    func bouncesHorizontally(_ newValue: Bool) -> Self {
        bouncesHorizontally = newValue
        return self
    }

    [@available(iOS 17.4, *)]
    @discardableResult
    func bouncesVertically(_ newValue: Bool) -> Self {
        bouncesVertically = newValue
        return self
    }
    ...
    [@available(iOS 17.4, *)]
    @discardableResult
    func transfersHorizontalScrollingToParent(_ newValue: Bool) -> Self {
        transfersHorizontalScrollingToParent = newValue
        return self
    }

    [@available(iOS 17.4, *)]
    @discardableResult
    func transfersVerticalScrollingToParent(_ newValue: Bool) -> Self {
        transfersVerticalScrollingToParent = newValue
        return self
    }
    ...
    [@available(iOS 17.0, *)]
    @discardableResult
    func allowsKeyboardScrolling(_ newValue: Bool) -> Self {
        allowsKeyboardScrolling = newValue
        return self
    }
